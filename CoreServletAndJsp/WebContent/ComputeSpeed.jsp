...
double displacement = toDouble(request.getParameter("displacement"));
/* double fortnights = toDouble(request.getParameter("fortnights")); */
double time = toDouble(request.getParameter("time"));
double speed = displacement/time;
%>

<UL>
  <LI>Distance: <%= displacement %> metre.
  <LI>Time: <%= time %> seconds.
  <LI>Speed: <%= speed %> displacement per seconds.
</UL>
